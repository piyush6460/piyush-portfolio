Piyush Pateliya	+91 6356630797
MERN Stack Developer	prpateliya6460@gmail.com
...
Languages: JavaScript, Verse
Frontend: React.js, Next.js, Tailwind CSS
Backend: Node.js, Express.js
Database: MongoDB (NoSQL)
State/API: Redux, React Query, REST APIs, Webhooks, JWT
AI-Assisted Development:  Antigravity, Claude Code
Tools: Git, GitHub, UEFN
Skills: Problem Solving, Self-learning, Technical creativity, Adaptability.

## Education

Bachelor of Computer Applications (B.C.A)
Maharaja Krishnakumarsinhji Bhavnagar University Swami Sahajanand College, (2020-2023)
8.6 CGPA

## Professional Experience

Appworld Infotech | UEFN Developer / Verse Programmer	Surat - Gujarat
Sep 2025 – Present
...
Bitfront Infotech | React.js Developer	Surat - Gujarat
May 2025 – Aug 2025
...
Tatvam Cloud Solution | MERN stack Developer	Surat - Gujarat
Dec 2023 – Apr 2025
Developed features for Wisernotify Social Proof and Wisernotify Product Review using the MERN stack.
Integrated REST APIs, webhooks, Google My Business (GMB), and Google Places for syschronization and review management.
